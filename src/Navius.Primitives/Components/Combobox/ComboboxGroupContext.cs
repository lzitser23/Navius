...
/// <summary>
/// Cascaded from <c>NaviusComboboxGroup</c> to a <c>NaviusComboboxGroupLabel</c> inside it.
/// The label publishes its generated id here; the group references it via
